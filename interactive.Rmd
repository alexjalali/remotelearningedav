...
<div id = "graph2"></div>
<script>
var width = 960,height = 720,centered;
...
g2.append('text')
  .classed('small-text', true)
  .attr('x', 157).attr('y', 125).text('75%');

g2.append('text')
  .classed('small-text', true)
  .attr('x', 157).attr('y', 144).text('70%');

g2.append('text')
  .classed('small-text', true)
  .attr('x', 157).attr('y', 163).text('65%');

g2.append('text')
  .classed('small-text', true)
  .attr('x', 157).attr('y', 182).text('60%');

g2.append('text')
  .classed('small-text', true)
  .attr('x', 157).attr('y', 201).text('55%');

g2.append('text')
  .classed('small-text', true)
  .attr('x', 157).attr('y', 220).text('50%');

g2.append("rect").attr('x', 120).attr('y', 119.2).attr('width', 30)
  .attr('height', 100).attr('fill', 'white').style('opacity',1).attr('stroke', 'black');
//created legend
g2.append("rect").attr('x', 120).attr('y', 120).attr('width', 30)
  .attr('height', 5).attr('fill', 'red').style('opacity',1);
g2.append("rect").attr('x', 120).attr('y', 125).attr('width', 30)
  .attr('height', 5).attr('fill', 'red').style('opacity',0.95);
g2.append("rect").attr('x', 120).attr('y', 130).attr('width', 30)
  .attr('height', 5).attr('fill', 'red').style('opacity',0.9);
g2.append("rect").attr('x', 120).attr('y', 135).attr('width', 30)
  .attr('height', 5).attr('fill', 'red').style('opacity',0.85);
g2.append("rect").attr('x', 120).attr('y', 140).attr('width', 30)
  .attr('height', 5).attr('fill', 'red').style('opacity',0.80);
g2.append("rect").attr('x', 120).attr('y', 145).attr('width', 30)
  .attr('height', 5).attr('fill', 'red').style('opacity',0.75);
g2.append("rect").attr('x', 120).attr('y', 150).attr('width', 30)
  .attr('height', 5).attr('fill', 'red').style('opacity',0.70);
g2.append("rect").attr('x', 120).attr('y', 155).attr('width', 30)
  .attr('height', 5).attr('fill', 'red').style('opacity',0.65);
g2.append("rect").attr('x', 120).attr('y', 160).attr('width', 30)
  .attr('height', 5).attr('fill', 'red').style('opacity',0.6);
g2.append("rect").attr('x', 120).attr('y', 165).attr('width', 30)
  .attr('height', 5).attr('fill', 'red').style('opacity',0.55);
g2.append("rect").attr('x', 120).attr('y', 170).attr('width', 30)
  .attr('height', 5).attr('fill', 'red').style('opacity',0.5);
g2.append("rect").attr('x', 120).attr('y', 175).attr('width', 30)
  .attr('height', 5).attr('fill', 'red').style('opacity',0.45);
g2.append("rect").attr('x', 120).attr('y', 180).attr('width', 30)
  .attr('height', 5).attr('fill', 'red').style('opacity',0.4);
g2.append("rect").attr('x', 120).attr('y', 185).attr('width', 30)
  .attr('height', 5).attr('fill', 'red').style('opacity',0.35);
g2.append("rect").attr('x', 120).attr('y', 190).attr('width', 30)
  .attr('height', 5).attr('fill', 'red').style('opacity',0.30);
g2.append("rect").attr('x', 120).attr('y', 195).attr('width', 30)
  .attr('height', 5).attr('fill', 'red').style('opacity',0.25);
g2.append("rect").attr('x', 120).attr('y', 200).attr('width', 30)
  .attr('height', 5).attr('fill', 'red').style('opacity',0.20);
g2.append("rect").attr('x', 120).attr('y', 205).attr('width', 30)
  .attr('height', 5).attr('fill', 'red').style('opacity',0.15);
g2.append("rect").attr('x', 120).attr('y', 210).attr('width', 30)
  .attr('height', 5).attr('fill', 'red').style('opacity',0.10);
g2.append("rect").attr('x', 120).attr('y', 215).attr('width', 30)
...
const xAxisshow = g2.append('g')
    .attr("transform",`translate(${550},${210})`);
...
const xAxisshow2 = g2.append('g')
    .attr("transform",`translate(${550},${465})`);

const yAxisshow2 = g2.append('g')
    .attr("transform",`translate(${550},${258})`);
...
d3.csv("https://raw.githubusercontent.com/alexjalali/remotelearningedav/main/datasets/DataClean.csv").then(function(data) {
  ...
  xlabel.classed('small-text', true).attr('x', 520).attr('y',45).text('Score');
  ylabel.classed('small-text', true).attr('x', 760).attr('y',215).text('Year');
  chartname1.attr('x', 570).attr('y', 55).text('Average Test Scores for 2018 & 2022');
  legend1.attr('x', 770).attr('y', 75).attr('width', 10)
  .attr('height', 10).attr('fill', '#0492C2').style('opacity',0.8);
  legend2.attr('x', 770).attr('y', 90).attr('width', 10)
  .attr('height', 10).attr('fill', '#597D35').style('opacity',0.8);
  legendlabel1.attr('x', 790).attr('y', 85).text('Math Score');
  legendlabel2.attr('x', 790).attr('y', 100).text('ELA Score');
  xAxisshow2.call(xAxis2);
	yAxisshow2.call(yAxis2);
  mediumText5.attr('x', 510).attr('y',243).text('Percentage');
  mediumText6.attr('x', 880).attr('y',470).text('Category');
  legend3.attr('x', 560).attr('y', 530).attr('width', 10)
  .attr('height', 10).attr('fill', '#800000').attr('opacity', 0.7);
  legend4.attr('x', 560).attr('y', 500).attr('width', 10)
  .attr('height', 10).attr('fill', '#008080').attr('opacity', 0.7);
  legendlabel3.attr('x', 580).attr('y', 540).text('Male');
  legendlabel4.attr('x', 580).attr('y', 509).text('Female');
  legendvalue3.attr('x', 580).attr('y', 525).text(female(d) + "%");
  legendvalue4.attr('x', 580).attr('y', 555).text(male(d) + "%");
  genderbar1.attr('x', 575)
    .attr('y', 465-(male(d))*(2.07)).attr('width', 30)
  	.attr('height', (male(d))*(2.07)).attr('fill', '#800000').attr('opacity', 0.7);
  genderbar2.attr('x', 575)
    .attr('y', 258).attr('width', 30)
  	.attr('height', (female(d))*(2.07))
    .attr('fill','#008080').attr('opacity', 0.7);
  legendlabel5.attr('x', 670).attr('y', 509).text('Asian');
  legendlabel6.attr('x', 670).attr('y', 540).text('Black');
  legendlabel7.attr('x', 670).attr('y', 570).text('Hispanic');
  legendlabel8.attr('x', 670).attr('y', 600).text('White');
  legendvalue5.attr('x', 670).attr('y', 525).text(asian(d) + "%");
  legendvalue6.attr('x', 670).attr('y', 555).text(black(d) + "%");
  legendvalue7.attr('x', 670).attr('y', 585).text(hispanic(d) + "%");
  legendvalue8.attr('x', 670).attr('y', 615).text(white(d) + "%");
  
  legend5.attr('x', 650).attr('y', 500).attr('width', 10)
  .attr('height', 10).attr('fill', '#F1948A');
  legend6.attr('x', 650).attr('y', 530).attr('width', 10)
  .attr('height', 10).attr('fill', '#BB8FCE');
	legend7.attr('x', 650).attr('y', 560).attr('width', 10)
  .attr('height', 10).attr('fill', '#85C1E9');
  legend8.attr('x', 650).attr('y', 590).attr('width', 10)
  .attr('height', 10).attr('fill', '#82E0AA');
  
  ethnicitybar1.attr('x', 655)
    .attr('y', 258).attr('width', 30)
  	.attr('height', (asian(d))*(2.07)).attr('fill','#F1948A');
  ethnicitybar2.attr('x', 655)
    .attr('y', 465-(white(d))*(2.07)-(hispanic(d))*(2.07)-(black(d))*(2.07)).attr('width', 30)
  	.attr('height', (black(d))*(2.07)).attr('fill', '#BB8FCE');
  ethnicitybar3.attr('x', 655)
    .attr('y', 465-(white(d))*(2.07)-(hispanic(d))*(2.07)).attr('width', 30)
  	.attr('height', (hispanic(d))*(2.07)).attr('fill', '#85C1E9');
  ethnicitybar4.attr('x', 655)
    .attr('y', 465-(white(d))*(2.07)).attr('width', 30)
  	.attr('height', (white(d))*(2.07)).attr('fill', '#82E0AA');
  
  legendlabel9.attr('x', 745).attr('y', 509).text('Grade 3');
  legendlabel10.attr('x', 745).attr('y', 540).text('Grade 4');
  legendlabel11.attr('x', 745).attr('y', 570).text('Grade 5');
  legendlabel12.attr('x', 745).attr('y', 600).text('Grade 6');
  legendlabel13.attr('x', 745).attr('y', 630).text('Grade 7');
  legendlabel14.attr('x', 745).attr('y', 660).text('Grade 8');
  
  legendvalue9.attr('x', 745).attr('y', 525).text(grade3(d) + "%");
  legendvalue10.attr('x', 745).attr('y', 555).text(grade4(d) + "%");
  legendvalue11.attr('x', 745).attr('y', 585).text(grade5(d) + "%");
  legendvalue12.attr('x', 745).attr('y', 615).text(grade6(d) + "%");
  legendvalue13.attr('x', 745).attr('y', 645).text(grade7(d) + "%");
  legendvalue14.attr('x', 745).attr('y', 675).text(grade8(d) + "%");
  
  legend9.attr('x', 725).attr('y', 500).attr('width', 10)
  .attr('height', 10).attr('fill', '#D6EAF8');
  legend10.attr('x', 725).attr('y', 530).attr('width', 10)
  .attr('height', 10).attr('fill', '#85C1E9');
	legend11.attr('x', 725).attr('y', 560).attr('width', 10)
  .attr('height', 10).attr('fill', '#5DADE2');
  legend12.attr('x', 725).attr('y', 590).attr('width', 10)
  .attr('height', 10).attr('fill', '#007AFF');
  legend13.attr('x', 725).attr('y', 620).attr('width', 10)
  .attr('height', 10).attr('fill', '#0000FF');
  legend14.attr('x', 725).attr('y', 650).attr('width', 10)
  .attr('height', 10).attr('fill', '#011F4B');
  
  gradebar3.attr('x', 735)
    .attr('y', 258).attr('width', 30)
  	.attr('height', (grade3(d))*(2.07)).attr('fill','#D6EAF8');
  gradebar4.attr('x', 735)
    .attr('y', 258+(grade3(d))*(2.07)).attr('width', 30)
  	.attr('height', (grade4(d))*(2.07)).attr('fill','#85C1E9');
  gradebar5.attr('x', 735)
  ...
  gradebar6.attr('x', 735)
    .attr('y', 465-(grade6(d))*(2.07)-(grade7(d))*(2.07)-(grade8(d))*(2.07)).attr('width', 30)
  	.attr('height', (grade6(d))*(2.07)).attr('fill', '#007AFF');
  gradebar7.attr('x', 735)
    .attr('y', 465-(grade7(d))*(2.07)-(grade8(d))*(2.07)).attr('width', 30)
  	.attr('height', (grade7(d))*(2.07)).attr('fill', '#0000FF');
  gradebar8.attr('x', 735)
    .attr('y', 465-(grade8(d))*(2.07)).attr('width', 30)
  	.attr('height', (grade8(d))*(2.07)).attr('fill', '#011F4B');
  
  legendlabel15.attr('x', 825).attr('y', 509).text('ELL');
  legendlabel16.attr('x', 825).attr('y', 540).text('Not ELL');
  legendvalue15.attr('x', 825).attr('y', 525).text(ELL(d) + "%");
  legendvalue16.attr('x', 825).attr('y', 555).text(NoELL(d) + "%");
  legend15.attr('x', 805).attr('y', 500).attr('width', 10)
  .attr('height', 10).attr('fill', '#D98880');
  legend16.attr('x', 805).attr('y', 530).attr('width', 10)
