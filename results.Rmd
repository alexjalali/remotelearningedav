...
### 2.Cleveland dot plot of remote learning preferences per district (Order by Highest to Lowest)
```{r}
...
library(ggpubr)
library(cowplot)
bpELA2019 <- gender_plot %>% ggplot(aes(fill=remote_cat, y=ELAScores2019, x=Category)) + geom_boxplot()
bpELA2022 <- gender_plot %>% ggplot(aes(fill=remote_cat, y=ELAScores2022, x=Category)) + geom_boxplot()
bpMath2019 <- gender_plot %>% ggplot(aes(fill=remote_cat, y=MathScores2019, x=Category)) + geom_boxplot()
bpMath2022 <- gender_plot %>% ggplot(aes(fill=remote_cat, y=MathScores2022, x=Category)) + geom_boxplot()
