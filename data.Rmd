...
names(district_1)[names(district_1) == "name.x.x"] = "Math_Scores_2019"
names(district_1)[names(district_1) == "name.y.x"] = "ELA_Scores_2019"
names(district_1)[names(district_1) == "name.x.y"] = "Math_Scores_2022"
names(district_1)[names(district_1) == "name.y.y"] = "ELA_Scores_2022"
...
```{r}
write.csv(df_super, file="./data/DataClean.csv")
```
