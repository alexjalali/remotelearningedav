...
names(learning_pref)[names(learning_pref) == "`Disaggregation Category`"] = "Disaggregation Category" #renaming variable to make it easier to merge with other datasets - removing unecessary ``
...
names(district_1)[names(district_1) == "name.x"] = "Math_Scores"
names(district_1)[names(district_1) == "name.y"] = "ELA_Scores"
```
